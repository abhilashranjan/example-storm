...
public class FakeTweetSpout implements IBatchSpout {
	...
	private static final Map<Integer, String> COUNTRY_MAP1 = new HashMap<Integer, String>();
	static {
		COUNTRY_MAP1.put(0, "United State");
		COUNTRY_MAP1.put(1, "Japan");
		COUNTRY_MAP1.put(2, "India");
		COUNTRY_MAP1.put(3, "China");
		COUNTRY_MAP1.put(4, "Brazil");
	}
	...
	private List<Object> recordGenerator() {
		...
		return new Values(TWEET_MAP.get(randomNumber),
				COUNTRY_MAP1.get(randomNumber2));
	}
